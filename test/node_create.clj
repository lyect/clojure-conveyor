...
(dosync (integer-channel-def/define-integer-channel))
...
(defn- test-node-function
  ...
  (channel-methods/create channel-types/IntegerT
                          number-channel-fields/value (+ (channel-methods/get-channel-field x number-channel-fields/value)
                                                         (channel-methods/get-channel-field y number-channel-fields/value)
...
(defn- derived-test-node-function
  ...
  (channel-methods/create channel-types/IntegerT
                          number-channel-fields/value (+ (channel-methods/get-channel-field x number-channel-fields/value)
                                                         (channel-methods/get-channel-field y number-channel-fields/value)
                                                         (channel-methods/get-channel-field z number-channel-fields/value)
                                                         (node-methods/get-node-field node ::f1)
